...
const Features6 = () => {
	...
	const features = [
		{
			title: "Partner-Led Solutions",
			desc: "Trusted global technology partners, delivered with local expertise and clear accountability.",
			icon: (
				<svg
					width="81"
					height="81"
		...
		},
		{
			...
			desc: "Security-first approach across identity, infrastructure, and cyber readiness from day one.",
			icon: (
				<svg
					width="80"
					height="81"
		...
		},
		{
			...
			desc: "Scope, planning, rollout, testing, training, and handover—managed in a clear process.",
			icon: (
				<svg
					width="80"
					height="81"
		...
		},
		{
			...
			desc: "Post-deployment support and service continuity to keep your operations stable and optimized.",
			icon: (
				<svg
					width="80"
					height="81"
					...
					<div className="col-lg-4 ">
						<div className="sec-heading h8-section-heading style-4">
							...
							<div className="desc wow fadeInUp" data-wow-delay="0.7s">
								<p>
									We deliver partner-led enterprise solutions with structured execution, security-first practices, and dependable long-term support.
								</p>
							</div>
